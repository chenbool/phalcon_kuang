...
<!--             <div class="demo-block load-with-head">
            ...
            <section id="tab">
                ...
                {#
                <ul class="ui-tiled ui-border-t ui-border-b" style="background-color: rgb(255, 255, 255);">
                    <li><div class="ui-txt-muted"><h5>涨幅</h5></div> <i class="ui-border"><h2 v-text="product.diff">--.--</h2></i></li> 
                    <li><div class="ui-txt-muted"><h5>涨跌</h5></div> <i class="ui-border"><h2 v-text="product.diff">--.--</h2></i></li> 
                    <li><div class="ui-txt-muted"><h5><a href="">导出</a></h5></div></li>
                </ul>
                #}
...
{# js content #}
{% block js %}
<script src="{{static_url('/static/blue/lib/echarts.min.js')}}"></script>
<script src="{{static_url('/static/blue/lib/good.js')}}"></script>
...
var vue=new Vue({
  ...
  methods: {
    ...
    submitBuy:function(){
        ...
        // console.log( data );
        $.post('{{ static_url('/good/order') }}',data,function(res){
              if( res.status > 0 ){
