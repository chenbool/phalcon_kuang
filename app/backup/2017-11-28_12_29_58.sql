...
-- -----------------------------------
-- Table structure for `w_conf` --
-- -----------------------------------
DROP TABLE IF EXISTS `w_conf`;
CREATE TABLE "w_conf" (
  ...
  "desc" mediumtext COMMENT '网页描述',
  "icp" varchar(40) DEFAULT NULL COMMENT '备案号',
  "copy" varchar(40) DEFAULT NULL COMMENT 'copy',
  "html" mediumtext COMMENT '统计',
  PRIMARY KEY ("id")
...
CREATE TABLE "w_menu" (
  ...
  PRIMARY KEY ("id"),
  UNIQUE KEY "name" ("name")
) ENGINE=MyISAM AUTO_INCREMENT=26 DEFAULT CHARSET=utf8 COMMENT='后台菜单';
...
CREATE TABLE "w_order" (
  "id" mediumint(9) unsigned NOT NULL AUTO_INCREMENT,
  "sn" varchar(40) NOT NULL COMMENT 'sn订单号',
  "uid" mediumint(9) unsigned NOT NULL COMMENT '用户id',
  "pid" mediumint(9) unsigned NOT NULL COMMENT '商品id',
  "money" decimal(6,2) unsigned NOT NULL COMMENT '订单金额',
...
-- -----------------------------------
-- Table structure for `w_recharge` --
-- -----------------------------------
DROP TABLE IF EXISTS `w_recharge`;
CREATE TABLE "w_recharge" (
  "id" mediumint(9) unsigned NOT NULL AUTO_INCREMENT,
  "sn" varchar(40) NOT NULL COMMENT '充值单号',
  "uid" mediumint(9) unsigned NOT NULL COMMENT '用户id',
  "money" decimal(6,2) unsigned NOT NULL COMMENT '充值金额',
  "add_time" int(11) unsigned NOT NULL COMMENT '充值时间',
  PRIMARY KEY ("id"),
  UNIQUE KEY "sn" ("sn")
...
CREATE TABLE "w_user" (
  ...
  "phone" varchar(12) NOT NULL COMMENT '手机号',
  "email" varchar(40) NOT NULL COMMENT '邮箱',
  "integral" smallint(6) unsigned NOT NULL COMMENT '积分',
  "money" decimal(8,2) unsigned NOT NULL COMMENT '余额',
  "exp" smallint(6) unsigned NOT NULL COMMENT '经验',
  "amount" decimal(8,2) unsigned NOT NULL COMMENT 'l累计充值总金额',
...
-- insert of `w_admin` --
-- ---------------------------------
 INSERT INTO `w_admin` VALUES ('2','2','bool','bool','c506ff134babdd6e68ab3e6350e95305','c506ff134babdd6e68ab3e6350e95305','127.0.0.1','127.0.0.1','17052850083','17052850083','30024167@qq.com','30024167@qq.com','0','0','1511784696','1511784696','1511596252','1511596252','3','3');
 INSERT INTO `w_admin` VALUES ('1','1','admin','admin','21232f297a57a5a743894a0e4a801fc3','21232f297a57a5a743894a0e4a801fc3','127.0.0.1','127.0.0.1','17052850083','17052850083','17052850083','17052850083','0','0','1511797108','1511797108','0','0','2','2');
...
-- insert of `w_conf` --
-- ---------------------------------
 INSERT INTO `w_conf` VALUES ('1','1','网站名称','网站名称','关键词1,关键词2','关键词1,关键词2','网站描述','网站描述','京ICP备11008151号','京ICP备11008151号','Copyright © Phalcon中文网','Copyright © Phalcon中文网','代码统计','代码统计');
...
-- ---------------------------------
 ...
 INSERT INTO `w_menu` VALUES ('2','2','0','0','产品管理','产品管理','fa-file','fa-file','0','0','1','1','0-2','0-2','','','','','product','product','0','0','1505894656','1505894656');
 ...
 INSERT INTO `w_menu` VALUES ('5','5','0','0','管理员管理','管理员管理','fa-user','fa-user','0','0','2','2','0-5','0-5','','','','','admin','admin','0','0','1505894656','1505894656');
 ...
 INSERT INTO `w_menu` VALUES ('8','8','0','0','数据库管理','数据库管理','fa-database','fa-database','0','0','5','5','0-8','0-8','','','','','database','database','0','0','1505894656','1505894656');
 INSERT INTO `w_menu` VALUES ('9','9','8','8','数据管理','数据管理','','','0','0','0','0','0-8-9','0-8-9','database','database','index','index','database','database','1','1','1505894656','1505894656');
 INSERT INTO `w_menu` VALUES ('10','10','8','8','备份列表','备份列表','','','0','0','0','0','0-8-10','0-8-10','database','database','index','index','database','database','1','1','1505894656','1505894656');
 INSERT INTO `w_menu` VALUES ('11','11','0','0','日志管理','日志管理','fa-file-text','fa-file-text','1','1','1','1','0-11','0-11','','','','','log','log','0','0','1505894656','1505894656');
 INSERT INTO `w_menu` VALUES ('12','12','11','11','操作日志','操作日志','','','1','1','0','0','0-11-12','0-11-12','log','log','index','index','log','log','1','1','1505894656','1505894656');
 INSERT INTO `w_menu` VALUES ('13','13','11','11','错误日志','错误日志','','','1','1','0','0','0-11-12','0-11-12','log','log','index','index','log','log','1','1','1505894656','1505894656');
 INSERT INTO `w_menu` VALUES ('14','14','0','0','应用商店','应用商店','fa-shopping-bag','fa-shopping-bag','0','0','6','6','0-14','0-14','store','store','index','index','store','store','0','0','1505894656','1505894656');
 INSERT INTO `w_menu` VALUES ('16','16','0','0','系统设置','系统设置','fa-cogs','fa-cogs','0','0','6','6','0-16','0-16','','','','','conf','conf','0','0','1505894656','1505894656');
 INSERT INTO `w_menu` VALUES ('15','15','0','0','界面设计','界面设计','fa-dashboard','fa-dashboard','0','0','4','4','0-15','0-15','ui','ui','index','index','ui','ui','0','0','1505894656','1505894656');
 INSERT INTO `w_menu` VALUES ('17','17','0','0','客户管理','客户管理','fa-user','fa-user','0','0','5','5','0-17','0-17','user','user','index','index','user','user','0','0','1505894656','1505894656');
 ...
 INSERT INTO `w_menu` VALUES ('23','23','16','16','基本配置','基本配置','','','0','0','0','0','0-16-23','0-16-23','conf','conf','index','index','conf','conf','1','1','1505894656','1505894656');
 INSERT INTO `w_menu` VALUES ('24','24','16','16','支付配置','支付配置','','','0','0','0','0','0-16-24','0-16-24','conf','conf','pay','pay','conf','conf','1','1','0','0');
 INSERT INTO `w_menu` VALUES ('25','25','16','16','短信配置','短信配置','','','0','0','0','0','0-16-25','0-16-25','conf','conf','sms','sms','conf','conf','1','1','0','0');
