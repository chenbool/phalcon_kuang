...
<div class="page-title">
	...
	<div class="page-breadcrumb">
		<ol class="breadcrumb">
			<li><a href="<?= $this->url->getStatic('/admin/user/index') ?>">客户管理</a></li> 
			<li><a href="<?= $this->url->getStatic('/admin/user/index') ?>">客户列表</a></li>
		</ol>
	</div>
</div>
						...
						<div class="col-md-12">
                            <section class="panel">
                                ...
                                <header class="panel-heading">
                                    <a href="<?= $this->url->getStatic('/admin/user/add') ?>">
