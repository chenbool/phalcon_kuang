...
<div class="page-title">
	...
	<div class="page-breadcrumb">
		<ol class="breadcrumb">
			<li><a href="<?= $this->url->getStatic('/admin/product/cate') ?>">产品分类</a></li> 
			<li><a href="<?= $this->url->getStatic('/admin/product/cateadd') ?>">分类添加</a></li>
		</ol>
	</div>
</div>
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal bordered-group form" role="form" action="/tp/admin.php/Role/add" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="radio" name="state" value="0" checked="checked"> 正常 &nbsp;&nbsp;&nbsp;&nbsp;
...
$('.submit').click(function(){
    ...
    $.post('<?= $this->url->getStatic('/admin/product/cateadd') ?>',data,function(res){
