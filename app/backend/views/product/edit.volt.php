...
<div class="page-title">
	...
	<div class="page-breadcrumb">
		<ol class="breadcrumb">
			<li><a href="<?= $this->url->getStatic('/admin/product/index') ?>">产品列表</a></li> 
			<li><a href="<?= $this->url->getStatic('/admin/product/add') ?>">产品编辑</a></li>
		</ol>
	</div>
</div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        产品编辑 
                        <a class="pull-right" href="<?= $this->url->getStatic('/admin/product/index') ?>" > 返回列表 </a>
                        </header>
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal bordered-group form" role="form" action="/tp/admin.php/Role/add" method="post">
                                    ...
                                    <div class="col-sm-6">
                                        <select class="form-control" name="pid">
                                            <?php foreach ($menu as $vo) { ?>    
                                                <option value="<?= $vo->id ?>" <?php if ($vo->id == $info->pid) { ?> selected="selected" <?php } ?> > <?= $vo->name ?> </option> 
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2 col-xs-6">
                                        <select class="form-control api_type" name="api">
                                            <?php foreach ($api as $vo) { ?>  
                                                <option value="<?= $vo->type ?>" <?php if ($vo->type == $info->type) { ?> selected="selected" <?php } ?> > <?= $vo->name ?> </option>  
                                            <?php } ?>   
                                        </select>
                                    </div>
                                    <div class="col-sm-2 col-xs-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2 col-xs-6">
                                        <select class="form-control" name="game_rule">
                                            <option value="0"  <?php if (0 == $info->game_rule) { ?> selected="selected" <?php } ?> > 默认 </option>    
                                            <option value="1"  <?php if (1 == $info->game_rule) { ?> selected="selected" <?php } ?> > 点位 </option>       
                                            <option value="2"  <?php if (2 == $info->game_rule) { ?> selected="selected" <?php } ?> > 竞猜 </option>    
                                        </select>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="radio" name="state" value="0" <?php if (0 == $info->state) { ?> checked="checked" <?php } ?> > 使用 &nbsp;&nbsp;&nbsp;&nbsp;
                                        <input type="radio" name="state" value="1" <?php if (1 == $info->state) { ?> checked="checked" <?php } ?>> 禁用
                                    </div>
                                </div>
...
<script type="text/javascript" src="<?= $this->url->getStatic('/admin/js/underscore-min.js') ?>"></script>
...
function apiList(){
    ...
    $.post('<?= $this->url->getStatic('/admin/product/apilist') ?>',{type:api_type},function(res){
...
$('.submit').click(function(){
    ...
    $.post('<?= $this->url->getStatic('/admin/product/edit') ?>',data,function(res){
