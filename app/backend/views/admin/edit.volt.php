                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal bordered-group form" role="form" action="/tp/admin.php/Role/add" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control name" value="<?= $info->username ?>" disabled="disabled">
                                        <input type="hidden" class="form-control name" placeholder="用户名" name="username" value="<?= $info->username ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control name" placeholder="邮箱" name="email" value="<?= $info->email ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control name" placeholder="手机号" name="phone" value="<?= $info->phone ?>">
                                    </div>
                                </div>
<!-- 
                                <div class="form-group">
...
-->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="password" class="form-control name" placeholder="密码" name="password" value="<?= $info->password ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="password" class="form-control name" placeholder="密码" name="c_password" value="<?= $info->password ?>">
                                    </div>
                                </div>
...
$('.submit').click(function(){
    ...
    $.post('<?= $this->url->getStatic('/admin/admin/edit') ?>',data,function(res){
