...
<div class="page-title">
	<div class="page-breadcrumb">
		<ol class="breadcrumb">
			...
			<li><a href="<?= $this->url->getStatic('/admin/ui/index') ?>"> 界面设计 </a></li>
		</ol>
	</div>
</div>
...
function install(name){
    ...
    $.post('<?= $this->url->getStatic('/admin/ui/install') ?>',{name:name},function(res){
        ...
        if( res.status > 0 ){
            ...
            layer.msg( res.info[0] )
            setTimeout(function(){
                location.href = '<?= $this->url->getStatic('/admin/ui/index') ?>';
            },1500);
        }
